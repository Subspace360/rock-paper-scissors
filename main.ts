...
function startGame () {
    ...
    sprites.destroy(paperS)
    sprites.destroy(rockS)
    sprites.destroy(scissorsS)
    ...
    scissorsS = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.scissors)
    paperS.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    rockS.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    scissorsS.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    paperS.follow(rockS)
    rockS.follow(scissorsS)
    scissorsS.follow(paperS)
}
sprites.onOverlap(SpriteKind.rock, SpriteKind.scissors, function (sprite, otherSprite) {
    scissorsS.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    music.play(music.melodyPlayable(music.pewPew), music.PlaybackMode.InBackground)
    info.player3.changeScoreBy(1)
})
sprites.onOverlap(SpriteKind.scissors, SpriteKind.paper, function (sprite, otherSprite) {
    paperS.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    music.play(music.melodyPlayable(music.pewPew), music.PlaybackMode.InBackground)
    info.player2.changeScoreBy(1)
})
sprites.onOverlap(SpriteKind.paper, SpriteKind.rock, function (sprite, otherSprite) {
    rockS.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    music.play(music.melodyPlayable(music.pewPew), music.PlaybackMode.InBackground)
    info.player1.changeScoreBy(1)
})
let scissorsS: Sprite = null
...
startGame()
forever(function () {
    console.log("Paper Score: " + info.player1.score())
    console.log("Scissors Score: " + info.player2.score())
